...
class SampleAdmin(admin.ModelAdmin):
    list_display = ('order', 'sample_name', 'concentration', 'volume', 'ratio_260_280', 'ratio_260_230', 'comments', 'internal_id', 'mixs_metadata_standard', 'mixs_metadata',  'filename_forward', 'filename_reverse', 'status')
